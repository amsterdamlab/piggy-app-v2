 ...
 * Perfectly fitted inside 100dvh without extra padding or scroll.
 */
export function renderDescargarView() {
    ...
    app.innerHTML = `
        ...
        <div class="page animate-fade-in pwa-download-page">
            <!-- Top Section: Centered Logo & Main Card -->
            <div>
                <!-- Centered Logo Principal -->
                <div style="text-align: center; margin-top: 4px; margin-bottom: 16px;">
                    <img src="/piggyapp_logo1.png" alt="Piggy App Logo" style="max-width: 150px; height: auto; display: block; margin: 0 auto;" onerror="this.onerror=null; this.src='/pig2.jpg';" />
                </div>

                <!-- Main Hero Card -->
                <div class="profile-data-card" style="margin: 0; text-align: center; padding: 22px 18px 18px; box-shadow: 0 12px 32px -8px rgba(0,0,0,0.06); border-radius: 22px; border: 1px solid #e2e8f0; background: white;">
            ...
            <!-- Bottom Section: Secondary Link & Well-spaced Professional Footer -->
            <div style="display: flex; flex-direction: column; align-items: center; gap: 14px; padding-bottom: 4px;">
                <!-- Secondary Link -->
                ...
                <!-- Footer Identidad Valle Morales bien organizado y espaciado -->
                <div style="text-align: center; width: 100%; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                    ...
                    <img src="/vallemorales_logo.png" alt="Valle Morales" style="max-height: 30px; width: auto; object-fit: contain; display: block; margin: 2px auto;" onerror="this.onerror=null; this.src='/pig2.jpg';" />

                    <!-- Derechos Reservados en 1 sola línea -->
                    <div style="font-size: 0.7rem; color: #94a3b8; font-weight: 500; text-align: center; white-space: nowrap;">
