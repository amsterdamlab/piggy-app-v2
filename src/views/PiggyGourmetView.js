      ...
      <div class="page__content">
        ...
        <div class="animate-fade-in" style="margin-bottom:24px;">
          ...
          <p style="font-size: var(--text-sm); color: var(--color-text-secondary); line-height: var(--leading-relaxed); margin: 0;">
            Encuentra diferentes cortes en cerdo, pollo y res de la mejor calidad directo desde Granja Villa Morales del Valle SAS. 👌 <strong>¡Haz tu pedido aquí!</strong>.
          </p>
        </div>
