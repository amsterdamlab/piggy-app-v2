...
export const Icons = {
    ...
    meat: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M 12.5 4.5 C 7.5 6 5 11 6.5 15.5 C 7.5 17.5 9.5 18.2 12 17 C 16.5 15 20.5 11.8 21 9.5 C 21.5 7 19.5 4.5 16 4.5 C 14.5 4.5 13.5 4.3 12.5 4.5 Z"/><ellipse cx="16.2" cy="8.2" rx="4.8" ry="3.5" transform="rotate(-32 16.2 8.2)"/><circle cx="16.2" cy="8.2" r="1.2" fill="currentColor"/><path d="M 7 16 L 4.8 18.2"/><path d="M 3.8 17.5 C 2.5 16.5 1.5 18 2.2 19.2 C 2.8 20.2 4 20 4.5 19.2 C 4.8 20.5 6.2 20.8 7 19.8 C 7.8 18.8 7.2 17.5 6.2 17.2 Z"/></svg>`,
};
