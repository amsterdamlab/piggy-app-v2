...
export const Icons = {
    ...
    meat: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M 4 10 C 3 13.5 5.5 16 9.5 16.8 C 14.5 17.8 20.5 14.8 21.5 11 C 22.2 7.8 19 5 15.5 5.2 C 12.5 5.4 10.5 7.5 7.5 7 C 5.5 6.5 4.5 7.8 4 10 Z"/><path d="M 4 10 C 3.5 14.2 6.5 18 11 19.8 C 16.5 21.8 21.5 17.5 21.5 11"/><path d="M 9.5 18.5 L 12.5 18.5"/><path d="M 14.5 18 L 16 17.5"/><path d="M 6.5 10.5 C 5.8 12.2 6.8 14.2 9.8 14.5 C 13 14.8 14.2 13 12.5 11.2 C 10.8 9.5 7.8 8.8 6.5 10.5 Z"/><path d="M 13.8 8.2 C 15.2 7.2 18 7.5 18.5 9.5 C 19 11.5 16.8 12.8 15 11.5 C 13.5 10.5 12.8 9.2 13.8 8.2 Z"/></svg>`,
};
