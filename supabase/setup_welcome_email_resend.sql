...
BEGIN
  ...
  v_html_body := '<!DOCTYPE html>'
    ...
    || '<a href="https://app.migranjapiggy.com/" class="btn-primary">Entrar a Mi Granja</a>'
    || '<p style="font-size:12px; color:#94a3b8; text-align:center; margin:15px 0 0;">Accede a tu granja de engorde. Tu acceso ya está 100% activo.</p>'
    || '</div>'
    || '<div class="footer">'
